...
export const portfolioData = [
  {
    ...
    picture: process.env.PUBLIC_URL + `/images/project1.jpg`,
  ...
  },
  {
    ...
    picture: process.env.PUBLIC_URL + `/images/project2.jpg`,
  ...
  },
  {
    ...
    picture:  process.env.PUBLIC_URL + '/images/project3.jpg',
  ...
  },
  {
    ...
    info: "Intégration l'interface du site avec du code HTML, CSS et JavaScript. Application dynamique grâce à JavaScript.",
    picture:  process.env.PUBLIC_URL + '/images/project4.jpg',
  ...
  },
  {
    ...
    picture:  process.env.PUBLIC_URL + '/images/project6.jpg',
